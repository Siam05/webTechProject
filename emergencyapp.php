...
<head>
	...
	<script src="emergencyappVal.js"></script>
	<style type="text/css">	   
		td{
			padding: 8px 5px ;
		}
...
<body>
	...
	<center><h1>Emergency Appointment</h1></center>
 		<table>
 			<div class="input">
	 		<tr>
	 			<td>Doctor Id</td>
		...
		<a href="emtoken.php"> See Your Entry</a>
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql = mysqli_query($con,"insert into em_appointment (did, date, time, name, phone) values('$id','$date','$time','$name','$phone')");
		if(($sql)){
